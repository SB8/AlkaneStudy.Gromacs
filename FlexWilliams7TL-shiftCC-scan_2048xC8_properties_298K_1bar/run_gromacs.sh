...
gmx grompp -f mdp_EM.mdp -c 2048xC8-AA_5nsEq-CHARMM36.gro -p topol_0.010.top -o tpr_EM.tpr -n index.ndx
gerun mdrun_mpi -s tpr_EM.tpr -c gro_EM.gro -g log_EM.log -e edr_EM.edr -o trr_EM.trr -table tables/table_0.010.xvg

gmx grompp -f mdp_NPT_eq.mdp -c gro_EM.gro -p topol_0.010.top -o tpr_NPT_eq.tpr -n index.ndx
gerun mdrun_mpi -s tpr_NPT_eq.tpr -c gro_NPT_eq.gro -g log_NPT_eq.log -e edr_NPT_eq.edr -x xtc_NPT_eq.xtc -table tables/table_0.010.xvg

gmx grompp -f mdp_NPT_sim.mdp -c gro_NPT_eq.gro -p topol_0.010.top -o tpr_NPT_sim_0.010.tpr -n index.ndx
