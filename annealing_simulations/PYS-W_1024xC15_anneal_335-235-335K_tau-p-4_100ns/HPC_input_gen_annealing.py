...
currentCoords = '1024xC15-UA_4nsEq-PYS.gro'
...
mdp_anneal['nsteps'] = '25000000' # 50ns - 2fs time step!
...
newSim.set_param('ref-t', anneal_temps[0])
newSim.set_param('gen-temp', anneal_temps[0])
