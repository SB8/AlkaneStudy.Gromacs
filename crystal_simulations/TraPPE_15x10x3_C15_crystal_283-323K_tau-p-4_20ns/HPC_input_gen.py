...
mdp_eq['nsteps'] = '1000000' # 2fs time step
mdp_eq['Pcoupltype'] = 'anisotropic'
mdp_eq['compressibility'] = '5e-5 5e-5 5e-5 0.0 0.0 0.0'
mdp_eq['ref-p'] = '1.0 1.0 1.0 0.0 0.0 0.0'

mdp_anneal = dict(mdp.NPT)
# Anisotropic pressure coupling
mdp_anneal['Pcoupltype'] = 'anisotropic'
mdp_anneal['compressibility'] = '5e-5 5e-5 5e-5 0.0 0.0 0.0'
...
mdp_anneal['annealing-time'] = '0 20000' # ps
mdp_anneal['nsteps'] = '10000000' # 20ns - 2fs time step!
mdp_anneal['nstxout-compressed'] = '10000' # 1000 frames in total
