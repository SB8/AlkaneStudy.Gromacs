...
currentCoords = 'C16-UA_18x18x4.gro'
...
mdp_eq['nsteps'] = '2000000' # 4ns, 2fs time step
mdp_eq['Pcoupltype'] = 'anisotropic'
mdp_eq['compressibility'] = '5e-5 5e-5 5e-5 5e-5 5e-5 5e-5' # xx, yy, zz, xy/yx, xz/zx and yz/zy
mdp_eq['ref-p'] = '1.0 1.0 1.0 0.0 0.0 0.0'

mdp_anneal = mdp.NPT
# Anisotropic pressure coupling
mdp_anneal['Pcoupltype'] = 'anisotropic'
mdp_anneal['compressibility'] = '5e-5 5e-5 5e-5 5e-5 5e-5 5e-5' # xx, yy, zz, xy/yx, xz/zx and yz/zy
