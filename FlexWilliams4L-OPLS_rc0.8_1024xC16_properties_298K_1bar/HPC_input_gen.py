...
# Energy minimization
newSim = SimGromacs([mdpFF, shortCutoffs, mdp.EM], shellFile, 
			mdrun=mdrunCmd,
			suffix='EM', 
			traj='trr',
...
newSim = SimGromacs([mdpFF, shortCutoffs, mdp.NPT_eq], shellFile, 
			mdrun=mdrunCmd,
			suffix='NPT_eq',
			coords=currentCoords)
currentCoords = newSim.coordsOut
...
# NPT production run
newSim = SimGromacs([mdpFF, shortCutoffs, mdp.NPT], shellFile, 
			mdrun=mdrunCmd,
			suffix='NPT_sim',
			coords=currentCoords)
currentCoords = newSim.coordsOut
