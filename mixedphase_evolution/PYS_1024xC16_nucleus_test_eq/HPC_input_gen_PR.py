...
currentCoords = 'C16_UA_P-1_1x1x1_unwrapped_nucleus_16x16x4_s2x2x0.gro'
...
# NVT melting at high temperature with position restraints
...
#mdpNVTeq['refcoord_scaling'] = 'all'

newSim = SimGromacs([mdpFF, mdpNVTeq], shellFile, 
			mdrun=mdrunCmd,
			suffix='NVTeq_'+str(Teq)+'K',
			topol='topol_PR.top',
...
# NPT Tmax -> T+ with position restraints
