...
gmx grompp -f mdp_NPT_eq.mdp -c 1024xC16-AA_2nsEq-Sun9-6.gro -p topol.top -o tpr_NPT_eq_0.tpr
...
gmx grompp -f mdp_NPT_eq.mdp -c gro_NPT_sim_2.gro -p topol.top -o tpr_NPT_eq_3.tpr
...
gmx grompp -f mdp_NPT_eq.mdp -c gro_NPT_sim_3.gro -p topol.top -o tpr_NPT_eq_4.tpr
