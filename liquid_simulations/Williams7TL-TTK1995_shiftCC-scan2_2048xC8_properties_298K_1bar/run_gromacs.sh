...
gmx grompp -f mdp_NPT_eq.mdp -c 2048xC8-AA_4nsEq-FWL7_shiftCC_1E-2_no-vel.gro -p topol_0.000.top -o tpr_NPT_eq.tpr -n index.ndx
...
gmx grompp -f mdp_NPT_sim.mdp -c gro_NPT_sim_0.002.gro -p topol_0.004.top -o tpr_NPT_sim_0.004.tpr -n index.ndx
